...
generate_cpp_functions <- function() {
  ...
  Sys.chmod(cpp_filename, "644")
  out <- file(cpp_filename)
  writeLines("// Generated by bin/generate.R -> do not edit by hand\n\n#include \"raylibr.h\"\n", out)
...
generate_cpp_wrappers_imp <- function(s) {
  ...
  Sys.chmod(cpp_filename, "644")
  write("// Generated by bin/generate.R -> do not edit by hand\n\n#include \"raylibr.h\"\n\nusing namespace Rcpp;\n\nnamespace Rcpp {\n\n", cpp_filename)
