...
The `raylibr` package allows you to do all of this from R, and offers the following usability improvements:
...
* Use R color names (e.g., use `"hotpink"` instead of `0xff69b4ff` or `list(r = 255, g = 105, b = 180, a = 255)`) 
