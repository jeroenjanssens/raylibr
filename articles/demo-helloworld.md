...
The simplest raylibr demo: open a window, draw a pulsing set of
concentric circles, and fade two text labels in and out using
[`sin()`](https://rdrr.io/r/base/Trig.html) over time. It demonstrates
the core game loop
