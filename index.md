...
This R package wraps [Raylib 6.0](https://www.raylib.com/), a simple and
easy-to-use library to enjoy videogames programming. It includes
webR/WASM support for running Raylib games in the browser.
...
- Function and class names are in snake_case (instead of PascalCase used
  by Raylib)
...
![](reference/figures/raylibr-demo-helloworld.gif)
...
![](reference/figures/raylibr-demo-raycaster.gif)
...
![](reference/figures/raylibr-demo-snake.gif)
...
![](reference/figures/raylibr-demo-cubes.gif)
...
- [Dirk Eddelbuettel](https://twitter.com/eddelbuettel) and others for
  creating the [Rcpp package](https://www.rcpp.org/), which enables the
  interface with Raylib.
...
- [Jared Lander](https://twitter.com/jaredlander) and team for allowing
  me to [present about R &
